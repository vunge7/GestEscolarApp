 ...
 * @author Necia Caculo
 */
public  class ListarPagamentoPropinaTurma {
    ...
    public ListarPagamentoPropinaTurma(Date data_inicio, Date data_fim, int idTurma) {
    ...
    public void mostrar() throws SQLException {
        ...
        hashMap.put("TURMA", this.idTurma);
        ...
        String relatorio = "relatorio/RelatorioPagamentoTurma.jasper";
...
//    }
    ...
    public static void main(String[] args) {
        new ListarPagamentoPropinaTurma(new Date(), new Date(), 1);
    }
