 ...
 */
public class MapaPropinasREPORT
{
    ...
    private Turma turma;
    private final String REPORT = "MapaApontamentoPropina.jrxml";

    public MapaPropinasREPORT( List<MapaApontamentoPropinaUtil> lista_mapa, Turma turma )
    {
    ...
    public static void main( String[] args )
    {
        ...
        MapaPropinasREPORT mapaPropinasREPORT = new MapaPropinasREPORT( lista_exemplo, turma );
